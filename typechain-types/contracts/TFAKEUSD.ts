...
export interface TFAKEUSDInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "COOLDOWN_PERIOD"
      | "DEFAULT_MINT_AMOUNT"
  ...
  encodeFunctionData(
    functionFragment: "DEFAULT_MINT_AMOUNT",
    values?: undefined
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "timeUntilNextMint",
    values: [AddressLike]
  ): string;
  encodeFunctionData(
...
export interface TFAKEUSD extends BaseContract {
  connect(runner?: ContractRunner | null): TFAKEUSD;
  waitForDeployment(): Promise<this>;

  interface: TFAKEUSDInterface;
  ...
  DEFAULT_MINT_AMOUNT: TypedContractMethod<[], [bigint], "view">;
  ...
  timeUntilNextMint: TypedContractMethod<
    [account: AddressLike],
    [bigint],
    "view"
  >;
  ...
  getFunction(
    nameOrSignature: "DEFAULT_MINT_AMOUNT"
  ): TypedContractMethod<[], [bigint], "view">;
  getFunction(
  ...
  getFunction(
    nameOrSignature: "timeUntilNextMint"
  ): TypedContractMethod<[account: AddressLike], [bigint], "view">;
  getFunction(
